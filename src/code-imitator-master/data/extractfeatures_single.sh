...
SRC="${AUTHORSHIP_EVASION}/data/dataset_2017_4/dataset_2017_8_121_formatted_macrosremoved/"
OUTPUT_DIR="${AUTHORSHIP_EVASION}/data/dataset_2017_4/libtoolingfeatures_2017_8_121_formatted_macrosremoved/"
mkdir -p $OUTPUT_DIR
